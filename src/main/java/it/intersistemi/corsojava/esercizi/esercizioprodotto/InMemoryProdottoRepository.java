...
public class InMemoryProdottoRepository implements ProdottoRepository {
	...
	@Override
	public ProdottoNegozio findByCodice(int codice) {
...
return magazzinoProdotti.get(codice) != null; //meglio perch� potre ritrovarmi un codice con prodotto associato null
	...
	public ProdottoNegozio deleteByCodice(int codice) {
