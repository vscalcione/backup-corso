		...
		<div class="container">
			...
			<form action="${saveUrl}" method="post">
				...
				<c:if test="${not empty user.userId}">
					<label>User id:</label> ${user.userId}<br><input type="hidden" name="userId" value="${user.userId}">
				</c:if>
				...
				<label>Enabled:</label> <input type="checkbox" name="enabled" ${user.enabled?'checked':''} value="true"> <br>
				<input type="reset" value="Cancella"> <input type="submit" value="Salva">
			</form>
			<c:if test="${not empty user.userId}"> <hr>
